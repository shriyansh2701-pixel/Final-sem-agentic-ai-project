...
# =============================================================================
# 2. EMAIL FETCHING LOGIC (IMAP - Multi-Email Version)
# =============================================================================

def get_unread_emails(username, password, limit=5):
    """
    Fetches the last 'limit' unread emails.
    Returns: A list of dictionaries: [{'subject':..., 'sender':..., 'body':...}, ...]
    """
    email_list = []
    ...
    try:
        ...
        # Only get the last few to save time (reverse order to get newest first)
...
with st.sidebar:
    ...
    gmail_pass = st.text_input("App Password", type="password", placeholder="abcd efgh ijkl mnop")
    gemini_key = st.text_input("Gemini API Key", type="password", value="AIzaSyDrd8fXpCaqCgzWUaMX7INBXl2OZuhnTlg") 
    ...
    if 'email_list' in st.session_state and st.session_state['email_list']:
        ...
        # Find the actual email data based on selection index
...
def create_crew(api_key):
    os.environ["GEMINI_API_KEY"] = "AIzaSyDrd8fXpCaqCgzWUaMX7INBXl2OZuhnTlg"
...
if selected_email_data:
    ...
    # Show email body in a clean box
    ...
    #App passwors=lpav cjen ieiy kbpy